            ...
            legs: [{
                ...
                steps: [{
                    ...
                    },
                    {
                        ...
                        maneuver: "turn-left",
                        polyline: {
                            encodedPath: "ecxiGa~hk@|ADrAFN?P@X@d@Dh@FZDL@D?D?TA"
                        },
                        startLocation: {
                            lat: 43.7101098,
                            lng: 7.2600099
                    ...
                    },
                    {
                        ...
                        polyline: {
                            encodedPath: "{vwiG{|hk@PCDAF?J@~@DdBDpAFT@d@@v@B^?@?`@?"
                        },
                        startLocation: {
                            lat: 43.708142,
                            lng: 7.2598218
                    ...
                    },
                    {
                        ...
                        maneuver: "turn-right",
                        polyline: {
                            encodedPath: "_hwiGc|hk@@lA@P@J@L?N@T@~@A|@?PD~@FDF@HBF@XBH@b@DF@v@Jp@DH@D@HBLB"
                        },
                        startLocation: {
                            lat: 43.70575729999999,
                            lng: 7.259703099999999
                    ...
                    },
                    {
                        ...
                        maneuver: "turn-right",
                        polyline: {
                            encodedPath: "cupiG}{`k@FB@@?@`@pAVbABHz@zCFRPj@H\\b@vA@F@BBDBDBFTX@@\\^BDBD@BJZTbABNJd@BHRr@"
                        },
                        startLocation: {
                            lat: 43.6720155,
                            lng: 7.218711099999999
                    ...
                    },
                    {
                        ...
                        maneuver: "straight",
                        polyline: {
                            encodedPath: "}ipiGcb`k@Cx@ShDE\\Gx@GdAAFCj@InACr@Gl@C`@I~AG|@KtAKdAu@|LCl@AXYhEGz@IvA]rFOxB"
                        },
                        startLocation: {
                            lat: 43.6702281,
                            lng: 7.214585
                    ...
                    },
                    {
                        ...
                        maneuver: "ramp-left",
                        polyline: {
                            encodedPath: "krpiGm}}j@DH@B@DBFFFHDD?B@JATK\\W\\WLI@ARKDAD?D@NEP?PDJHLLBH@BBFDJBHDRT`A@B@HDRD\\@H?D?T?JAVAXAFE`@ADG^Id@CNGX?@Mj@Sv@?DELAJEHEHGLGJIFGDIBIBI@M?ICGCKGIKIMG]CIAM?O@QBSBIDKFIFGDENILALATBD?HBN@FBD?@?B?NCNHPFXRDDHFXTJJHFBDPTNTJP@@LTN^Pb@N`@FTDNDNNn@H\\DPDPThABNNp@Ln@l@vCDNj@nCJj@BH"
                        },
                        startLocation: {
                            lat: 43.6715783,
                            lng: 7.2035881
                    ...
                    },
                    {
                        ...
                        maneuver: "ramp-right",
                        polyline: {
                            encodedPath: "q{khGuyx`@e@\\CBABA@A@ALIn@UjA"
                        },
                        startLocation: {
                            lat: 43.4836056,
                            lng: 5.5389855
                    ...
                    },
                    {
                        ...
                        maneuver: "fork-right",
                        polyline: {
                            encodedPath: "c~khGatx`@Mb@ADCJCDKXKVEFCF?@QZEFAD[j@KPCFCDCFABCFEPCLCN?BAD?B?FAT@R?@@PBP@HBHHV@FN`@@BRb@P\\P`@HTJZBFDPFZBHRv@R|@"
                        },
                        startLocation: {
                            lat: 43.484018,
                            lng: 5.538086
                    ...
                    },
                    {
                        ...
                        maneuver: "turn-left",
                        polyline: {
                            encodedPath: "k}khG{yw`@Nj@FR@PH?^AZ@TBVBH@R?ZDXBTBL@N?LAJANAJCXINGPKNKDCHIJKFILQn@y@pAgBJOV[RYhA{A^g@x@gAR[NQLSjA{A~@qADGzAsBd@m@"
                        },
                        startLocation: {
                            lat: 43.4839013,
                            lng: 5.533898799999999
                    ...
                    },
                    {
                        ...
                        maneuver: "turn-right",
                        polyline: {
                            encodedPath: "}yjhGgtx`@BLBL@F@J@JBb@B`@@F@d@@p@@H?H?L@f@@X@h@?LBZ@ZBZ@N@L@\\Bz@?^?R@XAH@V?dA@P?T@r@@N?Z@Z?B?D?N@P@T@J?TBXBVBXDXBXDVDXBXHn@DZF`@Hf@FXLj@BDJ`@Tt@d@xAZ`AHTFTPh@HTPh@Pj@Ph@Ph@FRHT`@pAFRHTDNFPDPJ^DRBPBNF\\BLBT@D@DJTBFDPFVDXBX@Z@XFR"
                        },
                        startLocation: {
                            lat: 43.4782286,
                            lng: 5.5381222
                    ...
                    },
                    {
                        ...
                        maneuver: "keep-left",
                        polyline: {
                            encodedPath: "wuchGknd`@PVj@z@T\\TZT^HJNV"
                        },
                        startLocation: {
                            lat: 43.4417207,
                            lng: 5.434781800000001
                    ...
                    },
                    {
                        ...
                        maneuver: "fork-right",
                        polyline: {
                            encodedPath: "kdpgGm`y_@JBH?NCj@GXCb@Ab@Al@Av@GZCd@Gb@Gb@GNCVC`@IPCPAb@GRCb@Eh@EdAGfAGp@E`@CfBMTA\\CfCQTAp@EzBOtJo@`Ga@PAPAB?\\CjBMLANAXCb@CVA@AnAGJAfBMlAIb@CRCD?RAr@EFAfBMxAIn@ELAfAIJAb@Cd@CNALAj@E`@ATAj@?l@@@?h@@VBJ@^Bf@DrAL"
                        },
                        startLocation: {
                            lat: 43.3416565,
                            lng: 5.3762324
                    ...
                    },
                    {
                        ...
                        maneuver: "fork-left",
                        polyline: {
                            encodedPath: "ctlgGwly_@\\?VBz@HdAJr@F`@D~@HhALh@DdAJz@HB@b@DxALJ@b@Dr@H|@HN@f@DB@`@JlEb@`DXtBTD?pFh@zANF?f@FfCV\\Bt@Hd@DD@j@Dn@HB?PBd@DVBpEb@XBpALn@Fp@FjHp@J@hGl@r@Ft@FfAFJ@n@Ft@FD@p@FNB`AJ\\Bb@DVBRF"
                        },
                        startLocation: {
                            lat: 43.3237014,
                            lng: 5.3781992
                    ...
                    },
                    {
                        ...
                        maneuver: "turn-right",
                        polyline: {
                            encodedPath: "}|hgGoxx_@CZAd@YhCCVIJ?@ABAFEVE^Gf@"
                        },
                        startLocation: {
                            lat: 43.3046263,
                            lng: 5.374964599999999
                    ...
                    },
                    {
                        ...
                        polyline: {
                            encodedPath: "c_igGqmx_@E?CAE?C?C@C@E@CBA@A@A@?@A@A@A@?@CHADAD?D?D?B?D@D?D@D@B@B@BBB@BB@@BB@B@F@B?B?BAB?DABC@ABCBC@EDG?E@E@E?E?E?E?Ef@YFKZORKvAq@dCkA~@g@vAu@"
                        },
                        startLocation: {
                            lat: 43.3049849,
                            lng: 5.3732083
                    ...
                    },
                    {
                        ...
                        polyline: {
                            encodedPath: "qohgGcux_@nBr@r@VNH"
                        },
                        startLocation: {
                            lat: 43.3024875,
                            lng: 5.3744239
                    ...
                    },
                    {
                        ...
                        maneuver: "straight",
                        polyline: {
                            encodedPath: "}ihgGmrx_@RR^EHEj@[@?f@Yn@[JCDABAJ?H?F@D?d@LZF\\FB@H@JBLBTEPD`@H"
                        },
                        startLocation: {
                            lat: 43.3015863,
                            lng: 5.3739876
                    ...
                    },
                    {
                        ...
                        maneuver: "straight",
                        polyline: {
                            encodedPath: "m{ggGisx_@H@B?ZBZB^B"
                        },
                        startLocation: {
                            lat: 43.2992654,
                            lng: 5.374130999999999
                    ...
                    },
                    {
                        ...
                        polyline: {
                            encodedPath: "gxggG{rx_@~@?X?l@AdAA"
                        },
                        startLocation: {
                            lat: 43.2987632,
                            lng: 5.374064499999999
                    ...
                    },
                    {
                        ...
                        maneuver: "turn-left",
                        polyline: {
                            encodedPath: "}qggG}kx_@~CmCrA_ADEJGHEFAF?D?H?HBHDJF"
                        },
                        startLocation: {
                            lat: 43.2977548,
                            lng: 5.3729501
                    ...
                    },
                    {
                        ...
                        maneuver: "turn-right",
                        polyline: {
                            encodedPath: "mgggGorx_@w@nEARAN?R@RNzC@XT~E@RJvB"
                        },
                        startLocation: {
                            lat: 43.29607,
                            lng: 5.3740032
